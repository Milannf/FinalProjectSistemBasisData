        ...
        <div className="glass border border-white/20 rounded-3xl p-8 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-yellow-400 transition-colors"
                required
              />
            </div>
            <div>
          ...
          <div className="mt-6 text-center">
            <button
              onClick={handleGuest}
              disabled={loading}
              className="w-full py-3 rounded-xl border border-white/30 text-white font-rajdhani hover:bg-white/10 transition-colors disabled:opacity-50"
            >
