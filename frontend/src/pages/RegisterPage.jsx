          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-cyan-400 transition-colors"
                required
              />
            </div>
            <div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-orbitron font-bold text-lg hover:scale-105 transition-transform disabled:opacity-50"
            >
